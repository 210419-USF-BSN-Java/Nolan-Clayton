...
public class ManagerRejectDelegate {

private ReimbursementDao rd = new ReimbursementDao();
private UserDao ud = new UserDao();
private ReimbursementStatusDao rsd = new ReimbursementStatusDao();
	
	public void rejectRequest(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		reimb.setReimbStatus(rsd.getById(2));
